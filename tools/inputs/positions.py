...
# ★ 2026-08-20：<b>2603 長榮（1 張、成本 193.28）已於 246 元全數賣出並移出追蹤</b>，本檔不再列入。
#   實現損益 +52,720 元（+27.28%）。出清依據為 08/19 報告訂下的「帶量站上 52 週高點 242.50 元
#   則改移動停利」——08/20 盤中量比 2.38 倍突破後於 246 元出清。
# ★ 2026-08-17：2618 長榮航（5 張、成本 35.35）已全數賣出並移出追蹤。
POS = {
 # 代號        股數    每股成本   已領股利/股
